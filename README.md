Запуск диаграммки:
sudo docker run --rm -it -v $(pwd):/data -p 5173:5173 likec4/likec4 serve --listen 0.0.0.0
...
насчет альтернативного варианта: самое просто всегда можно сделать просто один монолит c модулями внутри, чтобы была простая цепочка (пользователь -> web app -> gateway -> report (монолит) -> db)
